...
async function seed15PerModel() {
  console.log('🌱 Seeding 15 customers per model...\n');
  ...
  try {
    ...
    console.log(`📊 Found ${cars.length} car models\n`);
    ...
    const firstNames = ['Juan', 'Maria', 'Pedro', 'Ana', 'Jose', 'Rosa', 'Carlos', 'Elena', 'Miguel', 'Sofia', 
                        ...
                        'Ricardo', 'Laura', 'Roberto', 'Cristina', 'Fernando', 'Monica', 'Diego', 'Andrea',
                        'Gabriel', 'Valentina', 'Daniel', 'Camila', 'Jorge', 'Lucia', 'Rafael', 'Isabella',
                        'Alejandro', 'Natalia', 'Javier', 'Gabriela', 'Sergio', 'Daniela', 'Andres', 'Victoria'];
    const lastNames = ['Dela Cruz', 'Santos', 'Reyes', 'Garcia', 'Mendoza', 'Fernandez', 'Ramos', 'Torres', 
                       ...
                       'Martinez', 'Rodriguez', 'Perez', 'Sanchez', 'Ramirez', 'Flores', 'Jimenez', 'Alvarez'];
    ...
    for (const car of cars) {
      ...
      for (let i = 0; i < 15; i++) {
        ...
        // Small delay to ensure queue numbers are sequential
        await new Promise(resolve => setTimeout(resolve, 50));
      }
    }

    console.log(`\n✅ Successfully seeded ${totalCreated} registrations (15 per model)!\n`);
    console.log(`📊 Total: ${cars.length} models × 15 customers = ${totalCreated} registrations\n`);
